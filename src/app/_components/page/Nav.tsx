...
const NavLink = async (props: {
	...
	return (
		<li className='w-[45lvh] h-[calc(45lvh*3/4)] list-none transition-all justify-self-center bg-cover '>
			<Link
				...
				<span className='z-20 drop-shadow-md border-b-2 border-white bg-transparent transition-all translate-y-[18lvh] group-hover/navlink:translate-y-0 group-focus/navlink:translate-y-0 font-extrabold text-xl'>
					{title}
				</span>
