const AboutMe = () => {
	return (
		<section className='py-48 w-11/12 lg:w-max px-8 flex flex-col justify-center lg:grid grid-cols-4 grid-rows-3 gap-8 lg:gap-y-0 lg:gap-x-8'>
			<h2 className='font-poppins block p-4 bg-white text-black top-0 m-0 z-10 text-4xl text-center col-span-1 row-span-3 rounded-3xl w-min text-nowrap self-center'>
				About Me
			</h2>
